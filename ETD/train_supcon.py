...
from dataset import ETDDataset
...
def set_loader(opt):
    ...
    train_dataset = ETDDataset(root_dir=data_dir, 
                               window_size=opt.window_size)
    val_dataset = ETDDataset(root_dir=data_dir, 
                             window_size=opt.window_size,
                             is_train=False)
...
# python3 ETD/train_supcon.py --data_dir=./data/ksm_conv33x33/ --model=resnet18 --save_freq=10 --window_size=33 --epochs=200 --num_workers=8 --temp=0.07 --learning_rate=0.1 --learning_rate_classifier=0.01 --cosine --epoch_start_classifier=170 --batch_size=1024
